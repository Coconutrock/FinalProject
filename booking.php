            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="15-7">July 15, 2024</option>
                        <option value="16-7">July 16, 2024</option>
                        <option value="6-7">July 17, 2024</option>
                        <option value="1-8">July 18, 2024</option>
                        <option value="11-7">July 19, 2024</option>
                    </select>
